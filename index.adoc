...
* https://todo.com[Introducción al Data Warehousing - No disponible, window=_blank]
...
* link:Docs/Tema04/Enlaces.html[Enlaces de interés, window=_blank]

### Tema 5. Tendencias actuales

* https://todo.com[Tendencias actuales - No disponible, window=_blank]
* link:Docs/Tema05/Enlaces.html[Enlaces de interés, window=_blank]

## Trabajo autónomo

* link:Labs/Lab01/index.html[Lab 01. xxx, window=_blank] 
* link:Labs/Lab02/index.html[Lab 02. xxx, window=_blank]
* link:Labs/Lab03/index.html[Lab 03. xxx, window=_blank]
* link:Labs/Lab04/index.html[Lab 04. xxx, window=_blank]

.Actividades complementarias
****
Puedes profundizar en contenidos de la asignatura a través de estos recursos:

* https://todo.com[No disponible, window=_blank]
****
